...
class OaLoanOrderCallCommand extends Command
{
    protected $name = 'oa:loan-order-call';
    protected $description = 'OA系统调用借款指令';
...
EOF;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $res = $oaLoanLogic->batchCallPayOrder($conditions);
        foreach ($res as $k => $v) {
