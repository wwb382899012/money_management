...
class OaLoanOrderNotifyCommand extends Command
{
    protected $name = 'oa:loan-order-notify';
    protected $description = '资金系统通知OA系统借款状态';
...
EOF;
        $this->options = [
            ...
            ['order_num', 'r', InputOption::VALUE_REQUIRED, '借款指令编号'],
        ];
        parent::configure();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $res = $oaLoanLogic->batchNotifyOa($conditions);
        foreach ($res as $k => $v) {
