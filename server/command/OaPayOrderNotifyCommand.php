...
class OaPayOrderNotifyCommand extends Command
{
    protected $name = 'oa:pay-order-notify';
    protected $description = '资金系统通知OA系统付款状态';
...
EOF;
        $this->options = [
            ...
            ['order_num', 'r', InputOption::VALUE_REQUIRED, '付款指令编号'],
        ];
        parent::configure();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $res = $oaPayLogic->batchNotifyOa($conditions);
        foreach ($res as $k => $v) {
