...
class OaRepayOrderCallCommand extends Command
{
    protected $name = 'oa:repay-order-call';
    protected $description = 'OA系统调用还款指令';
...
EOF;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $res = $oaRepayLogic->batchCallPayOrder($conditions);
        foreach ($res as $k => $v) {
